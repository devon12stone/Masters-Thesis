...
This chapter has detailed the origins of credit scoring, the various techniques used within developing loan default prediction models, and how loan default prediction models can be improved using alternative data sources. The next chapter will detail the data sources used to create the datasets used throughout this project, the feature creation techniques used in this project, and the pre-processing completed on the datasets developed for the project before they were used to train various models. 